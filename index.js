let testData = [
	new Item('razor', '2', '12.45'),
	new Item('blaster', '4', '48.00'),
	new Item('rocket', '1', '112.90'),
	new Item('blazer', '3', '9.45'),
	new Item('thunder', '8', '1.10'),
	new Item('spur', '60', '0.40'),
	new Item('buck', '1', '1.00')
];
